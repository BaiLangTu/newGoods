...
package red.mlz.module.config.dynamic.datasource.aspect;
...
import red.mlz.module.config.dynamic.datasource.config.DynamicContextHolder;
...
public class DataSourceAspect {
    ...
    @Pointcut("@annotation(red.mlz.module.config.ReadOnly)")
